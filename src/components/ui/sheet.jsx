...
const sheetVariants = cva(
  "fixed z-[999] gap-4 bg-white p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500 dark:bg-[#2e2e2e]",
  {
    variants: {
      side: {
